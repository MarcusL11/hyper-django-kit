...
# TODO: Uncomment when characters app is created
...
# TODO: Uncomment when book_templates app is created
...
# TODO: Uncomment when books app is created
...
__all__ = [
    ...
    'language_english',
    'language_spanish',
    # Character fixtures - TODO: Uncomment when apps are created
    # 'user',
    # 'character_type_child',
    # 'character_type_adult',
    # 'character_type_dog',
    ...
    # 'adult_character',
    # 'animal_character',
    # Book template fixtures - TODO: Uncomment when apps are created
    # 'book_series',
    # 'book_template',
    # 'unpublished_book_template',
    # 'character_slot',
    ...
    # 'book_template_page_with_character_refs',
    # 'book_template_data',
    # Book fixtures - TODO: Uncomment when apps are created
    # 'book',
    # 'book_character_assignment',
    # 'book_page',
]
